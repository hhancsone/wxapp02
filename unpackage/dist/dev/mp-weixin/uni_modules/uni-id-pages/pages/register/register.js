  ...
  methods: {
    ...
    submitForm(params) {
      uniIdCo.registerUser(this.formData).then((e) => {
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/pages/register/register.vue:120", e.message);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("captcha", "12bc8df5-10,12bc8df5-9"),
    v: common_vendor.o(($event) => $data.formData.captcha = $event),
    w: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    x: common_vendor.sr("agreements", "12bc8df5-11,12bc8df5-0"),
    y: common_vendor.p({
      scope: "register"
    }),
    ...
    D: common_vendor.sr("form", "12bc8df5-0"),
    E: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
