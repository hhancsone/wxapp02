  ...
  methods: {
    ...
    submitForm(params) {
      uniIdCo.registerUserByEmail(this.formData).then((e) => {
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/pages/register/register-by-email.vue:163", e.message);
      });
    },
    navigateBack() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("shortCode", "57cb402e-10,57cb402e-9"),
    ...
    y: common_vendor.sr("agreements", "57cb402e-11,57cb402e-0"),
    z: common_vendor.p({
      scope: "register"
    }),
    ...
    E: common_vendor.sr("form", "57cb402e-0"),
    F: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
