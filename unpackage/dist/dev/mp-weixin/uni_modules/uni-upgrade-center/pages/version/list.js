...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.w(({
      ...
      return {
        a: "8df3c42a-4-" + i0 + "," + ("8df3c42a-3-" + i0),
        b: "8df3c42a-5-" + i0 + "," + ("8df3c42a-3-" + i0),
        c: "8df3c42a-6-" + i0 + "," + ("8df3c42a-3-" + i0),
        d: "8df3c42a-7-" + i0 + "," + ("8df3c42a-3-" + i0),
        e: "8df3c42a-8-" + i0 + "," + ("8df3c42a-3-" + i0),
        f: "8df3c42a-9-" + i0 + "," + ("8df3c42a-3-" + i0),
        g: "8df3c42a-10-" + i0 + "," + ("8df3c42a-3-" + i0),
        h: "8df3c42a-11-" + i0 + "," + ("8df3c42a-3-" + i0),
        i: "8df3c42a-12-" + i0 + "," + ("8df3c42a-3-" + i0),
        j: "8df3c42a-3-" + i0 + "," + ("8df3c42a-2-" + i0),
        k: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "8df3c42a-14-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            c: common_vendor.t(item.title || "-"),
            d: "8df3c42a-15-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            ...
            i: "8df3c42a-16-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            j: "8df3c42a-18-" + i0 + "-" + i1 + "," + ("8df3c42a-17-" + i0 + "-" + i1),
            k: common_vendor.p({
            ...
            l: "8df3c42a-17-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            m: common_vendor.t($options.store_list_key(item.store_list)),
            n: "8df3c42a-19-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            o: common_vendor.t(item.version),
            p: "8df3c42a-20-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            q: common_vendor.t(item.stable_publish == true ? "已上线" : "已下线"),
            r: "8df3c42a-21-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            s: "8df3c42a-23-" + i0 + "-" + i1 + "," + ("8df3c42a-22-" + i0 + "-" + i1),
            t: common_vendor.p({
              format: "yyyy-MM-dd hh:mm:ss",
              date: item.create_date,
              threshold: [0, 0]
            }),
            v: "8df3c42a-22-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            w: common_vendor.o(($event) => $options.navigateTo("./detail?id=" + item._id, false), index),
            x: "8df3c42a-24-" + i0 + "-" + i1 + "," + ("8df3c42a-13-" + i0 + "-" + i1),
            y: index,
            z: "8df3c42a-13-" + i0 + "-" + i1 + "," + ("8df3c42a-2-" + i0),
            A: common_vendor.p({
              disabled: item.stable_publish
            })
          };
        }),
        l: "8df3c42a-2-" + i0 + ",8df3c42a-1",
        m: common_vendor.p({
          loading,
    ...
    J: common_vendor.sr("udb", "8df3c42a-1"),
    K: common_vendor.p({
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/uni-upgrade-center/pages/version/list.js.map
