  ...
  return common_vendor.e({
    ...
    ab: common_vendor.f(_ctx.formData.store_list, (item, k0, i0) => {
      return {
        ...
        c: "4b3e2e64-25-" + i0 + "," + ("4b3e2e64-24-" + i0),
        ...
        f: "4b3e2e64-24-" + i0 + "," + ("4b3e2e64-23-" + i0),
        g: "4b3e2e64-27-" + i0 + "," + ("4b3e2e64-26-" + i0),
        ...
        j: "4b3e2e64-26-" + i0 + "," + ("4b3e2e64-23-" + i0),
        k: "4b3e2e64-29-" + i0 + "," + ("4b3e2e64-28-" + i0),
        l: common_vendor.o(($event) => item.priority = $event, item.id),
        m: common_vendor.p({
          type: "number",
          modelValue: item.priority
        }),
        n: "4b3e2e64-30-" + i0 + "," + ("4b3e2e64-28-" + i0),
        o: "4b3e2e64-28-" + i0 + "," + ("4b3e2e64-23-" + i0),
        p: "4b3e2e64-23-" + i0 + ",4b3e2e64-22",
        q: item.id
      };
    }),
    ac: common_vendor.p({
    ...
    aA: common_vendor.sr("form", "4b3e2e64-0"),
    aB: common_vendor.p({
      value: _ctx.formData,
