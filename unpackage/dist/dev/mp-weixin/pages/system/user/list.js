...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    o: common_vendor.w(({
      ...
      return {
        a: "2c8f3eb2-4-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        b: "2c8f3eb2-5-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        c: "2c8f3eb2-6-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        d: "2c8f3eb2-7-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        e: common_vendor.p({
          align: "center",
          ["filter-type"]: "select",
          ["filter-data"]: options.filterData.status_localdata
        }),
        f: "2c8f3eb2-8-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        g: "2c8f3eb2-9-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        h: "2c8f3eb2-10-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        i: "2c8f3eb2-11-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        j: "2c8f3eb2-12-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        k: "2c8f3eb2-13-" + i0 + "," + ("2c8f3eb2-3-" + i0),
        l: "2c8f3eb2-3-" + i0 + "," + ("2c8f3eb2-2-" + i0),
        m: common_vendor.f(data, (item, index, i1) => {
          return common_vendor.e({
            a: common_vendor.t(item.username),
            b: "2c8f3eb2-15-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            c: common_vendor.t(item.nickname),
            d: "2c8f3eb2-16-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            e: common_vendor.t(item.mobile),
            f: "2c8f3eb2-17-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            g: common_vendor.t(options.status_valuetotext[item.status]),
            h: "2c8f3eb2-18-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            i: "2c8f3eb2-20-" + i0 + "-" + i1 + "," + ("2c8f3eb2-19-" + i0 + "-" + i1),
            j: common_vendor.p({
              href: "mailto:" + item.email,
              text: item.email
            }),
            k: "2c8f3eb2-19-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            l: common_vendor.t(item.role),
            m: "2c8f3eb2-21-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            n: common_vendor.f(item.tags, (tag, tagIndex, i2) => {
              return common_vendor.e(item.tags ? {
                a: "2c8f3eb2-23-" + i0 + "-" + i1 + "-" + i2 + "," + ("2c8f3eb2-22-" + i0 + "-" + i1),
                b: common_vendor.p({
                  type: "primary",
                  inverted: true,
                  size: "small",
            ...
            o: item.tags,
            p: "2c8f3eb2-22-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            q: item.dcloud_appid === void 0
          }, item.dcloud_appid === void 0 ? {
            r: "2c8f3eb2-25-" + i0 + "-" + i1 + "," + ("2c8f3eb2-24-" + i0 + "-" + i1),
            s: common_vendor.p({
              href: $data.noAppidWhatShouldIDoLink
            })
          } : {}, {
            t: common_vendor.t(item.dcloud_appid),
            v: "2c8f3eb2-24-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            w: "2c8f3eb2-27-" + i0 + "-" + i1 + "," + ("2c8f3eb2-26-" + i0 + "-" + i1),
            x: common_vendor.p({
              threshold: [0, 0],
              date: item.last_login_date
            }),
            y: "2c8f3eb2-26-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            ...
            B: "2c8f3eb2-28-" + i0 + "-" + i1 + "," + ("2c8f3eb2-14-" + i0 + "-" + i1),
            C: index,
            D: "2c8f3eb2-14-" + i0 + "-" + i1 + "," + ("2c8f3eb2-2-" + i0)
          });
        }),
        n: common_vendor.sr("table", "2c8f3eb2-2-" + i0 + ",2c8f3eb2-1"),
        o: "2c8f3eb2-2-" + i0 + ",2c8f3eb2-1",
        p: common_vendor.p({
          loading,
    ...
    aa: common_vendor.sr("udb", "2c8f3eb2-1"),
    ...
    ad: common_vendor.sr("checkbox", "2c8f3eb2-32,2c8f3eb2-31"),
    ...
    ah: common_vendor.sr("tagsPopup", "2c8f3eb2-31"),
    ai: common_vendor.p({
      type: "center"
    })
  };
