...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    m: common_vendor.w(({
      ...
      return {
        a: "22cfbd93-5-" + i0 + "," + ("22cfbd93-4-" + i0),
        b: "22cfbd93-6-" + i0 + "," + ("22cfbd93-4-" + i0),
        c: "22cfbd93-7-" + i0 + "," + ("22cfbd93-4-" + i0),
        d: "22cfbd93-8-" + i0 + "," + ("22cfbd93-4-" + i0),
        e: "22cfbd93-9-" + i0 + "," + ("22cfbd93-4-" + i0),
        f: "22cfbd93-10-" + i0 + "," + ("22cfbd93-4-" + i0),
        g: "22cfbd93-4-" + i0 + "," + ("22cfbd93-3-" + i0),
        h: common_vendor.f(data, (item, index, i1) => {
          return common_vendor.e({
            a: common_vendor.t(item.sort),
            b: "22cfbd93-12-" + i0 + "-" + i1 + "," + ("22cfbd93-11-" + i0 + "-" + i1),
            c: common_vendor.t(item.name),
            d: "22cfbd93-13-" + i0 + "-" + i1 + "," + ("22cfbd93-11-" + i0 + "-" + i1),
            e: common_vendor.t(item.menu_id),
            f: "22cfbd93-14-" + i0 + "-" + i1 + "," + ("22cfbd93-11-" + i0 + "-" + i1),
            g: common_vendor.t(item.url),
            h: "22cfbd93-15-" + i0 + "-" + i1 + "," + ("22cfbd93-11-" + i0 + "-" + i1),
            i: item.enable,
            j: common_vendor.o(($event) => $options.enableChange(item), index),
            k: !item.enable ? 1 : "",
            l: "22cfbd93-16-" + i0 + "-" + i1 + "," + ("22cfbd93-11-" + i0 + "-" + i1),
            ...
            t: "22cfbd93-17-" + i0 + "-" + i1 + "," + ("22cfbd93-11-" + i0 + "-" + i1),
            v: index,
            w: "22cfbd93-11-" + i0 + "-" + i1 + "," + ("22cfbd93-3-" + i0)
          });
        }),
        i: "22cfbd93-3-" + i0 + ",22cfbd93-2",
        j: common_vendor.p({
          loading,
    ...
    y: common_vendor.sr("udb", "22cfbd93-2"),
    ...
    G: common_vendor.f($options.pluginMenus, (item, index, i0) => {
      return {
        ...
        c: "22cfbd93-24-" + i0 + "," + ("22cfbd93-23-" + i0),
        d: common_vendor.t(item.url),
        e: "22cfbd93-25-" + i0 + "," + ("22cfbd93-23-" + i0),
        f: common_vendor.t(item.json),
        g: "22cfbd93-26-" + i0 + "," + ("22cfbd93-23-" + i0),
        h: index,
        i: "22cfbd93-23-" + i0 + ",22cfbd93-18"
      };
    }),
    H: common_vendor.sr("pluginMenusTable", "22cfbd93-18"),
