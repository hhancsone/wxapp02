...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "ac224748-4-" + i0 + "," + ("ac224748-3-" + i0),
        b: "ac224748-5-" + i0 + "," + ("ac224748-3-" + i0),
        c: "ac224748-6-" + i0 + "," + ("ac224748-3-" + i0),
        d: "ac224748-7-" + i0 + "," + ("ac224748-3-" + i0),
        e: "ac224748-8-" + i0 + "," + ("ac224748-3-" + i0),
        f: "ac224748-9-" + i0 + "," + ("ac224748-3-" + i0),
        g: "ac224748-3-" + i0 + "," + ("ac224748-2-" + i0),
        h: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.role_id),
            b: "ac224748-11-" + i0 + "-" + i1 + "," + ("ac224748-10-" + i0 + "-" + i1),
            c: common_vendor.t(item.role_name),
            d: "ac224748-12-" + i0 + "-" + i1 + "," + ("ac224748-10-" + i0 + "-" + i1),
            e: common_vendor.t(item.permission),
            f: "ac224748-13-" + i0 + "-" + i1 + "," + ("ac224748-10-" + i0 + "-" + i1),
            g: common_vendor.t(item.comment),
            h: "ac224748-14-" + i0 + "-" + i1 + "," + ("ac224748-10-" + i0 + "-" + i1),
            i: "ac224748-16-" + i0 + "-" + i1 + "," + ("ac224748-15-" + i0 + "-" + i1),
            j: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            k: "ac224748-15-" + i0 + "-" + i1 + "," + ("ac224748-10-" + i0 + "-" + i1),
            ...
            n: "ac224748-17-" + i0 + "-" + i1 + "," + ("ac224748-10-" + i0 + "-" + i1),
            o: index,
            p: "ac224748-10-" + i0 + "-" + i1 + "," + ("ac224748-2-" + i0)
          };
        }),
        i: common_vendor.sr("table", "ac224748-2-" + i0 + ",ac224748-1"),
        j: "ac224748-2-" + i0 + ",ac224748-1",
        k: common_vendor.p({
          loading,
    ...
    M: common_vendor.sr("udb", "ac224748-1"),
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/system/role/list.js.map
