...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "13dd1563-4-" + i0 + "," + ("13dd1563-3-" + i0),
        b: "13dd1563-5-" + i0 + "," + ("13dd1563-3-" + i0),
        c: "13dd1563-6-" + i0 + "," + ("13dd1563-3-" + i0),
        d: "13dd1563-7-" + i0 + "," + ("13dd1563-3-" + i0),
        e: "13dd1563-8-" + i0 + "," + ("13dd1563-3-" + i0),
        f: "13dd1563-3-" + i0 + "," + ("13dd1563-2-" + i0),
        g: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.permission_id),
            b: "13dd1563-10-" + i0 + "-" + i1 + "," + ("13dd1563-9-" + i0 + "-" + i1),
            c: common_vendor.t(item.permission_name),
            d: "13dd1563-11-" + i0 + "-" + i1 + "," + ("13dd1563-9-" + i0 + "-" + i1),
            e: common_vendor.t(item.comment),
            f: "13dd1563-12-" + i0 + "-" + i1 + "," + ("13dd1563-9-" + i0 + "-" + i1),
            g: "13dd1563-14-" + i0 + "-" + i1 + "," + ("13dd1563-13-" + i0 + "-" + i1),
            h: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            i: "13dd1563-13-" + i0 + "-" + i1 + "," + ("13dd1563-9-" + i0 + "-" + i1),
            j: common_vendor.o(($event) => $options.navigateTo("./edit?id=" + item._id, false), index),
            k: common_vendor.o(($event) => $options.confirmDelete(item._id), index),
            l: "13dd1563-15-" + i0 + "-" + i1 + "," + ("13dd1563-9-" + i0 + "-" + i1),
            m: index,
            n: "13dd1563-9-" + i0 + "-" + i1 + "," + ("13dd1563-2-" + i0)
          };
        }),
        h: common_vendor.sr("table", "13dd1563-2-" + i0 + ",13dd1563-1"),
        i: "13dd1563-2-" + i0 + ",13dd1563-1",
        j: common_vendor.p({
          loading,
    ...
    K: common_vendor.sr("udb", "13dd1563-1"),
