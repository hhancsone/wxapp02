...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "511e2417-4-" + i0 + "," + ("511e2417-3-" + i0),
        b: "511e2417-5-" + i0 + "," + ("511e2417-3-" + i0),
        c: "511e2417-6-" + i0 + "," + ("511e2417-3-" + i0),
        d: "511e2417-7-" + i0 + "," + ("511e2417-3-" + i0),
        e: "511e2417-8-" + i0 + "," + ("511e2417-3-" + i0),
        f: "511e2417-9-" + i0 + "," + ("511e2417-3-" + i0),
        g: "511e2417-10-" + i0 + "," + ("511e2417-3-" + i0),
        h: "511e2417-3-" + i0 + "," + ("511e2417-2-" + i0),
        i: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "511e2417-12-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            c: common_vendor.t($options.getAppType(item.app_type)),
            d: "511e2417-13-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            e: common_vendor.t(item.name),
            f: "511e2417-14-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            g: common_vendor.t(item.description || "-"),
            h: "511e2417-15-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            i: common_vendor.t(item.remark || "-"),
            j: "511e2417-16-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            k: "511e2417-18-" + i0 + "-" + i1 + "," + ("511e2417-17-" + i0 + "-" + i1),
            l: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            m: "511e2417-17-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            ...
            r: "511e2417-19-" + i0 + "-" + i1 + "," + ("511e2417-11-" + i0 + "-" + i1),
            s: index,
            t: "511e2417-11-" + i0 + "-" + i1 + "," + ("511e2417-2-" + i0),
            v: common_vendor.p({
              disabled: item.appid === _ctx.appid
            })
          };
        }),
        j: common_vendor.sr("table", "511e2417-2-" + i0 + ",511e2417-1"),
        k: "511e2417-2-" + i0 + ",511e2417-1",
        l: common_vendor.p({
    ...
    S: common_vendor.sr("udb", "511e2417-1"),
