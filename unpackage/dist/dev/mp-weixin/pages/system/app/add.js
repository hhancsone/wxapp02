  ...
  return common_vendor.e({
    ...
    K: common_vendor.f(_ctx.appPlatformKeys, (item, k0, i0) => {
      return common_vendor.e({
        ...
        q: "db929a90-23-" + i0 + "," + ("db929a90-22-" + i0),
        ...
        w: "db929a90-22-" + i0 + ",db929a90-18",
        x: common_vendor.p({
          label: "上传apk包"
        })
      }) : {}, {
        y: "db929a90-25-" + i0 + "," + ("db929a90-24-" + i0),
        ...
        B: "db929a90-24-" + i0 + ",db929a90-18",
        C: common_vendor.p({
          label: item === "app_ios" ? "AppStore 链接" : "下载链接"
        }),
        D: item === "app_ios"
      }, item === "app_ios" ? {
        E: "db929a90-27-" + i0 + "," + ("db929a90-26-" + i0),
    ...
    L: common_vendor.sr("scheme", "db929a90-28,db929a90-18"),
    M: common_vendor.p({
    ...
    P: common_vendor.f(_ctx.formData.store_list, (item, index, i0) => {
      return {
        ...
        b: "db929a90-32-" + i0 + "," + ("db929a90-31-" + i0),
        c: common_vendor.o(($event) => item.name = $event, item.id),
        d: common_vendor.p({
          trim: "both",
          modelValue: item.name
        }),
        e: "db929a90-31-" + i0 + "," + ("db929a90-30-" + i0),
        f: "db929a90-34-" + i0 + "," + ("db929a90-33-" + i0),
        ...
        i: "db929a90-33-" + i0 + "," + ("db929a90-30-" + i0),
        j: "db929a90-30-" + i0 + ",db929a90-29",
        k: item.id
      };
    }),
    Q: common_vendor.p({
    ...
    V: common_vendor.f(_ctx.mpPlatformKeys, (item, k0, i0) => {
      return common_vendor.e({
        ...
        g: "db929a90-37-" + i0 + "," + ("db929a90-36-" + i0),
        h: common_vendor.o(($event) => _ctx.formData[item].name = $event, item),
        i: common_vendor.p({
          trim: "both",
          modelValue: _ctx.formData[item].name
        }),
        j: "db929a90-36-" + i0 + ",db929a90-35",
        k: common_vendor.p({
          label: "名称"
        }),
        ...
        n: "db929a90-39-" + i0 + "," + ("db929a90-38-" + i0),
    ...
    ae: common_vendor.sr("form", "db929a90-1"),
