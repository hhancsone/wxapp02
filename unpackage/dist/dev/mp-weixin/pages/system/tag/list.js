...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    j: common_vendor.w(({
      ...
      return {
        a: "d95c1284-5-" + i0 + "," + ("d95c1284-4-" + i0),
        b: "d95c1284-6-" + i0 + "," + ("d95c1284-4-" + i0),
        c: "d95c1284-7-" + i0 + "," + ("d95c1284-4-" + i0),
        d: "d95c1284-8-" + i0 + "," + ("d95c1284-4-" + i0),
        e: "d95c1284-9-" + i0 + "," + ("d95c1284-4-" + i0),
        f: "d95c1284-4-" + i0 + "," + ("d95c1284-3-" + i0),
        g: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.tagid),
            b: "d95c1284-11-" + i0 + "-" + i1 + "," + ("d95c1284-10-" + i0 + "-" + i1),
            c: "d95c1284-13-" + i0 + "-" + i1 + "," + ("d95c1284-12-" + i0 + "-" + i1),
            d: common_vendor.p({
              type: "primary",
              inverted: true,
              size: "small",
            ...
            e: "d95c1284-12-" + i0 + "-" + i1 + "," + ("d95c1284-10-" + i0 + "-" + i1),
            f: common_vendor.t(item.description),
            g: "d95c1284-14-" + i0 + "-" + i1 + "," + ("d95c1284-10-" + i0 + "-" + i1),
            h: "d95c1284-16-" + i0 + "-" + i1 + "," + ("d95c1284-15-" + i0 + "-" + i1),
            i: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            j: "d95c1284-15-" + i0 + "-" + i1 + "," + ("d95c1284-10-" + i0 + "-" + i1),
            ...
            n: "d95c1284-17-" + i0 + "-" + i1 + "," + ("d95c1284-10-" + i0 + "-" + i1),
            o: index,
            p: "d95c1284-10-" + i0 + "-" + i1 + "," + ("d95c1284-3-" + i0)
          };
        }),
        h: common_vendor.sr("table", "d95c1284-3-" + i0 + ",d95c1284-2"),
        i: "d95c1284-3-" + i0 + ",d95c1284-2",
        j: common_vendor.p({
          loading,
    ...
    G: common_vendor.sr("udb", "d95c1284-2"),
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/system/tag/list.js.map
