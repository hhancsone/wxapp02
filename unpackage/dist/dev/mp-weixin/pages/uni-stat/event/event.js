...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    q: common_vendor.sr("version-select", "7d5d660c-7"),
      ...
      return {
        a: common_vendor.f($data.fieldsMap, (mapper, index, i1) => {
          return {
            ...
            b: index,
            c: "7d5d660c-14-" + i0 + "-" + i1 + "," + ("7d5d660c-13-" + i0)
          };
        }),
        b: i,
        c: "7d5d660c-13-" + i0 + ",7d5d660c-10"
      };
    }),
    F: common_vendor.p({
      align: "center"
    ...
    K: common_vendor.sr("inputClose", "7d5d660c-17,7d5d660c-16"),
    ...
    O: common_vendor.sr("inputDialog", "7d5d660c-16"),
    P: common_vendor.p({
      type: "dialog",
      maskClick: true
    })
