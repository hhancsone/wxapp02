...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.sr("app-versions", "22be17da-2"),
      ...
      return {
        a: common_vendor.f($data.fieldsMap, (mapper, index, i1) => {
          return common_vendor.e({
            ...
            e: "22be17da-12-" + i0 + "-" + i1 + "," + ("22be17da-11-" + i0),
            f: common_vendor.p({
              align: "center"
            })
          } : {}, {
        ...
        b: "22be17da-11-" + i0 + "," + ("22be17da-10-" + i0),
          ...
          return {
            a: common_vendor.f($data.fieldsMap, (mapper, index, i2) => {
              return common_vendor.e({
                ...
                c: mapper.field,
                d: "22be17da-14-" + i0 + "-" + i1 + "-" + i2 + "," + ("22be17da-13-" + i0 + "-" + i1),
                e: common_vendor.p({
                  align: "left"
                })
              } : mapper.field === "create_time" ? {
                g: "22be17da-16-" + i0 + "-" + i1 + "-" + i2 + "," + ("22be17da-15-" + i0 + "-" + i1 + "-" + i2),
                h: common_vendor.p({
                  threshold: [0, 0],
                  date: item.create_time
                }),
                i: mapper.field,
                j: "22be17da-15-" + i0 + "-" + i1 + "-" + i2 + "," + ("22be17da-13-" + i0 + "-" + i1),
                k: common_vendor.p({
                  align: "center"
                })
              } : {
                ...
                m: mapper.field,
                n: "22be17da-17-" + i0 + "-" + i1 + "-" + i2 + "," + ("22be17da-13-" + i0 + "-" + i1),
                o: common_vendor.p({
                  align: "center"
                })
              }, {
            ...
            b: i,
            c: "22be17da-13-" + i0 + "-" + i1 + "," + ("22be17da-10-" + i0)
          };
        }),
        d: common_vendor.sr("table", "22be17da-10-" + i0 + ",22be17da-9"),
        e: "22be17da-10-" + i0 + ",22be17da-9",
        f: common_vendor.p({
          loading,
          border: true,
          stripe: true,
    ...
    v: common_vendor.sr("udb", "22be17da-9"),
