  ...
  methods: {
    ...
    getChartData(query, field = this.chartTabs[this.tabIndex]._id, name = this.chartTabs[this.tabIndex].name) {
      ...
      db.collection(this.tableName).where(query).field(`${js_sdk_uniStat_util.stringifyField(pages_uniStat_device_overview_fieldsMap.fieldsMap, field)}, start_time`).groupBy(`start_time`).groupField(js_sdk_uniStat_util.stringifyGroupField(pages_uniStat_device_overview_fieldsMap.fieldsMap, field)).orderBy("start_time", "asc").get({
        ...
        common_vendor.index.__f__("error", "at pages/uni-stat/device/overview/overview.vue:455", err);
      }).finally(() => {
      });
    },
    ...
    getPageData(query, type) {
      ...
      db.collection(subTableTemp, mainTableTemp).field(
        ...
        common_vendor.index.__f__("error", "at pages/uni-stat/device/overview/overview.vue:534", err);
      }).finally(() => {
      });
    },
    navTo(url) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    s: common_vendor.o(($event) => $data.chartTab = $event),
    t: common_vendor.p({
      type: "box",
    ...
    w: common_vendor.o(($event) => $options.navTo("/pages/uni-stat/page-res/page-res")),
    x: common_vendor.f($data.resFieldsMap, (mapper, index, i0) => {
      return common_vendor.e({
        a: mapper.title
      }, mapper.title ? {
        b: common_vendor.t(mapper.title),
        c: index,
        d: "60c59abf-12-" + i0 + ",60c59abf-11",
        e: common_vendor.p({
          align: "center"
        })
      } : {}, {
    ...
    y: common_vendor.f($data.resTableData, (item, i, i0) => {
      return {
        a: common_vendor.f($data.resFieldsMap, (mapper, index, i1) => {
          return common_vendor.e({
            ...
            c: index,
            d: "60c59abf-14-" + i0 + "-" + i1 + "," + ("60c59abf-13-" + i0),
            e: common_vendor.p({
    ...
    A: common_vendor.o(($event) => $options.navTo("/pages/uni-stat/page-ent/page-ent")),
    B: common_vendor.f($data.entFieldsMap, (mapper, index, i0) => {
      return common_vendor.e({
        a: mapper.title
      }, mapper.title ? {
        b: common_vendor.t(mapper.title),
        c: index,
        d: "60c59abf-17-" + i0 + ",60c59abf-16",
        e: common_vendor.p({
          align: "center"
        })
      } : {}, {
    ...
    C: common_vendor.f($data.entTableData, (item, i, i0) => {
      return {
        a: common_vendor.f($data.entFieldsMap, (mapper, index, i1) => {
          return common_vendor.e({
            ...
            b: common_vendor.t(item[mapper.field] !== void 0 ? item[mapper.field] : "-"),
            c: index,
            d: "60c59abf-19-" + i0 + "-" + i1 + "," + ("60c59abf-18-" + i0),
            e: common_vendor.p({
              align: index === 0 ? "left" : "center"
            })
          } : {}, {
