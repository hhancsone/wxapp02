  ...
  return {
    ...
    e: common_vendor.f(_ctx.logs, (log, index, i0) => {
      return {
        ...
        c: "172a278c-7-" + i0 + "," + ("172a278c-6-" + i0),
        d: common_vendor.t(log.route),
        e: log.route,
        f: "172a278c-8-" + i0 + "," + ("172a278c-6-" + i0),
        g: common_vendor.t(log.time),
        h: "172a278c-9-" + i0 + "," + ("172a278c-6-" + i0),
        i: "172a278c-10-" + i0 + "," + ("172a278c-6-" + i0),
        j: index,
        k: "172a278c-6-" + i0 + ",172a278c-0"
      };
    }),
    f: common_vendor.p({
      border: true,
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/windows/components/error-log.js.map
